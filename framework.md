...
sections:
  - name: Welcome to the FAME Framework
    ...
    - name: What does it look at?
      id: what
    - name: How was it developed?
      id: how
  - name: What is Facilitated Performance?
    id: facilitated-performance
    subsections:
    - name: The Activities of Facilitated Performance
      id: facilitating-activities
    - name: The Roles of a Facilitator
      id: roles
    - name: Facilitator Personas
      id: personas
  - name: Digital Musical Instruments in Facilitated Performance
    id: dmis
    subsections:
    - name: What is a Digital Musical Instrument?
      id: dmi-what
    - name: The Digital Musical Instrument Stack
      id: dmi-stack
  - name: Evaluating DMIs for Accessibility
    id: evaluating
    subsections:
    - name: Digital Musical Instrument Attributes
      id: attributes
    - name: The Accessible Instruments Checklist
      id: checklist
  - name: Conclusions
    id: conclusions
  - name: Glossary
